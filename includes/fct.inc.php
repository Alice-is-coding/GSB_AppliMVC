...
/**
 * Teste s'il s'agit d'un Visiteur
 *
 * @return vrai ou faux
 */
...
{
    if (estConnecte()) {
        return $_SESSION['typeUser'] == 1;
    }
    return false;
}

/**
 * Teste s'il s'agit d'un Comptable
 *
 * @return vrai ou faux
 */
 ...
 * @param Integer $typeusr    Type d'utilisateur
 *
 * @return null
 */
function connecter($idUtilisateur, $nom, $prenom, $typeusr)
{
    $_SESSION['idUtilisateur'] = $idUtilisateur;
    $_SESSION['nom'] = $nom;
    $_SESSION['prenom'] = $prenom;
    $_SESSION['typeUser'] = $typeusr;
}
